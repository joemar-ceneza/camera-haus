...
export default function Cart() {
    ...
    const stripePromise = loadStripe("pk_test_51NULHNLL9SaFonV4HXbhhyIobbTZWElP8aSBOAoh1Mf0BnNWvF4lbLsPPtUhkrSKZvmOTp9ONkUpot3aMxnfuRge00Q9V0YSB3");
        ...
        <div className="w-full h-full px-4 text-white">
            ...
            <div className="px-6">
                ...
                <div className="flex justify-between gap-x-4">
                    ...
                    <button onClick={() => handlePayment()} className="btn btn-accent hover:bg-accent-hover text-primary flex-1 px-2 gap-x-2"><IoArrowForward className="text-lg"/> Check out</button>
                </div>
                ) : (
