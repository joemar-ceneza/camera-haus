...
export default function Hero() {
    return (
        <section className="mb-[20px] pt-36 lg:pt-0">
                    ...
                    <div className="flex flex-col gap-y-[30px] w-full max-w-lg mx-auto h-[500px]">
                        ...
                        <div className="grad flex-1 h-[250px] rounded-[8px] overflow-hidden relative p-6">
                            ...
                            <div className="flex flex-col max-w-[144px] h-full justify-center">
                                ...
                                <a className="uppercase text-accent" href="#">shop now</a>
                            </div>
                            {/* image */}
                        ...
                        <div className="grad flex-1 h-[250px] rounded-[8px] overflow-hidden relative p-6">
                            {/* text */}
                            <div className="flex flex-col max-w-[144px] h-full justify-center">
                                <div className="text-[20px] uppercase font-medium leading-tight mb-4">Save 25% mirrorless cameras</div>
                                <a className="uppercase text-accent" href="#">shop now</a>
                            </div>
                            {/* image */}
